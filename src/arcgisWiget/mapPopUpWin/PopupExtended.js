...
export const PopupT = function (GIS) {


    let declare = GIS.declare;
    let lang = GIS.lang;
    let arrayUtils = GIS.array;
    let domConstruct = GIS['dom-construct'];
    let domStyle = GIS['dom-style'];
    let fx = GIS.fx;
    let on = GIS.on;
    let PopupTemplate = GIS.PopupTemplate;
    let Popup = GIS.Popup;

    dojo.declare('PT', GIS.Popup, {
        ...
        _callPopupApiMethodsFromFeature: function (feature, method) {
